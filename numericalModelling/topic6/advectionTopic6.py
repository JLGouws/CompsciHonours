...
fig, ax = plt.subplots(2, figsize = (6, 6.5), tight_layout = True)
ax[0].plot(x, solution[-1], lw = 4, label = "Lax-Wendroff", c = "darkcyan")
ax[0].plot(x, fx, ls = '--', dashes = (10, 10), label = "Exact", c = "palevioletred")
ax[0].legend()
ax[0].set_xlabel("$x$")
ax[0].set_ylabel("$u(x, t)$")

ax[1].plot(x, solution[-1], lw = 4, label = "Lax-Wendroff", c = "darkcyan")
ax[1].plot(x, eulerSolution[-1], ls = '--', dashes = (10, 10), label = "upwind-Euler", c = "darkorange")
ax[1].legend()
ax[1].set_xlabel("$x$")
