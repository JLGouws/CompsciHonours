  ...
  \item
    \begin{enumerate}
      \item
        ...
        \end{figure}
        \begin{enumerate}
          \item If the disease has these parameters, the infections peak after \input{2ai.tex} days.
          \item At the peak \input{2aii.tex} people will be infected at the same time.
          \item After approximately \input{2aiii.tex} days, no single person should be infected.
          \item The proportion of people who will be infected is \input{2aiiii.tex}.
        \end{enumerate}
      ...
      \item
        ...
        \end{figure}
        \begin{enumerate}
          \item If the disease has these parameters, the infecaions peak at approximately \input{2bi.tex}.
          \item At the peak \input{2bii.tex} people will be infected at the same time.
          \item After approximately \input{2biii.tex} days, no single person should be infected.
          \item The proportion of people who will be infected is \input{2biiii.tex}.
        \end{enumerate}
  \end{enumerate}
  \item
    \begin{enumerate}
