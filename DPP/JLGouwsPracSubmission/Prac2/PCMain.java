...
public final class PCMain
  {
    ...
    public PCMain ()
      { // Create channel object
        ...
        Consumer a = new Consumer(bcReqChannel.out(), bcChannel.in(), "ConsumerA"), //create two consumers
                 b = new Consumer(bcReqChannel.out(), bcChannel.in(), "ConsumerB"); //created here to get results later
        CSProcess[] procList = { 
        ...
        System.out.println("Output written to out2.txt");
      } // PCMain constructor
