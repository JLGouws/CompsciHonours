...
public class MessageClient
{
  ...
  private void sendMessage()
  {
    ...
    String b = sc.useDelimiter("\\Z").next();//^D to send message on Linux systems probably ^Z on windows
  ...
  private void retrieveLatest()
  {
    ...
    if (m == null)
      System.out.println("\033[H\033[2JYou have no messages."); //no messages
    else
      {
        System.out.println("\033[H\033[2JHere is the message. Press enter to return to the main menu.");
  ...
  private void getAll()
  {
    ...
    if (ms == null || ms.size() == 0)
      System.out.println("\033[H\033[2JYou have no messages.");
    else
