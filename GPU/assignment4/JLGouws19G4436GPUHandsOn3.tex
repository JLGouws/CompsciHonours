...
\block{1.0cm} {\large \textbf{\today}} \hfill {\large \textbf{19G4436}}\\
  ...
  \begin{table}[H]
    ...
    \begin{tabular}{ccccccc}
      \toprule
          ...
          \\ \midrule
      \multicolumn{1}{p{4em}}{$64 \times  8$ \newline 2D Grid} & 2.66404          & 87.8    & 50.334 & 100      & 25.167& 100 \\ 
      \hline
  ...
  \end{table}
  Observations:\\
  Doing sixteen consecutive data items per thread results in low load and store efficiency.
  Striding solves this problem and acheives the same memory efficiency as the single datum per thread approach.
